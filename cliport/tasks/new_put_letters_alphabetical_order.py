...
class PutLettersAlphabeticalOrder(Task):
    ...
    def __init__(self):
        ...
        self.task_completed_desc = "done putting the letters on the tables in alphabetical order."
    ...
    def reset(self, env):
        ...
        self.high_level_lang_goal = 'put the letters on the tables in alphabetical order'
